...
export default function Projects({ projects }: ProjectsProps) {
    ...
    // Sort projects from newest to oldest based on createdAt date
            ...
            <div className="w-[92%] max-w-[1536px] mx-auto">
                ...
                <div className="text-center mb-8 md:mb-16">
                    ...
                    <p className="text-text-muted text-sm md:text-base mt-3 md:mt-4 max-w-2xl mx-auto px-4">
                        Tap on any project to view the source code or link
                    </p>
                </div>
                                            ...
                                            <div className="flex items-center space-x-4">
                                                {getRepoUrl(project) && (
                                                    <span className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-neon-cyan text-dark-bg flex items-center justify-center neon-glow-cyan">
                                                        <svg className="w-5 h-5 md:w-6 md:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
